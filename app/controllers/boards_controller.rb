class BoardsController < ApplicationController
  wrap_parameters :board, include: %i[ name all_access auto_postpone_period_in_days work_planning_time_limit_in_seconds public_description ]
  ...
  private
    ...
    def board_params
      params.expect(board: [ :name, :all_access, :auto_postpone_period_in_days, :work_planning_time_limit_in_seconds, :public_description ])
    end
